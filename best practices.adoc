...
Select Content Consistently (Recommended):: Navigate to menu:File[Options > Advanced], then under "Editing options", uncheck "When selecting, automatically select entire word" and "Use smart paragraph selection". 

_This allows selection of content in Word to work more like selection in plaintext; i.e., Word will no longer fight you to make sure you select the period at the end of a sentence even if you don't want to._
...
It's probably best to avoid using Section Breaks. I use them _very occasionally_ for large documents (e.g., manuals) wherein things need to be done which cannot be done otherwise (e.g., different page numbering styles in different parts of the document). 
...
== Numbered Objects and Cross-References
...
. Include chapter number -- when inserting a caption, open the btn:[Numbering] dialog box, and select "include chapter number". Use a period as the separator.
